...
Router.prototype.matchMethod = function(method, url) {
  console.log('matchMethod() ' + method + ' ' + url);
  ...
  console.log(this._match(method, keyMatch(this.routes, origin), path));
...
Router.prototype.match = function(request) {
  console.log('match ---------------------------------');
  console.log(this.matchMethod(request.method, request.url));
